...
public interface Symmetry<P extends Point, E extends Symmetry<P, E>>
{
  ...
  /**
   * 
   * Returns a point that is not located on any of the symmetry
   * axis. This returned point is Normalized, that it
   * is located on the unitsphere in the Dimension of P
   * 
