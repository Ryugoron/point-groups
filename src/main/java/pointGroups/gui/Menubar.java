  ...
  extends JMenuBar
{
  ...
  public Menubar(final EventDispatcher dispatcher) {
    ...
    coordinateItem.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(final ActionEvent event) {
        dispatcher.fireEvent(new ShowCoordinateEvent(coordinateItem.getState()));
      }
    });

    previousItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P,
        ActionEvent.CTRL_MASK));
    nextItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N,
        ActionEvent.CTRL_MASK));
    pointPickerItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F,
        ActionEvent.CTRL_MASK));
    coordinateItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X,
        ActionEvent.CTRL_MASK));
