...
public class Schlegel3DComputeEvent extends Event<Schlegel3DComputeHandler>
{
  public final static Class<Schlegel3DComputeHandler> TYPE = Schlegel3DComputeHandler.class;
  private final Symmetry3DChooseEvent symmetryEvent;
  private final Point3D pickedPoint;
  
  public Schlegel3DComputeEvent(Symmetry3DChooseEvent symmetry3dChooseEvent, Point3D pickedPoint){
  ...
  @Override
  protected void dispatch(Schlegel3DComputeHandler handler) {
