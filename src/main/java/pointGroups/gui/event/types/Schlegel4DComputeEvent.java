...
public class Schlegel4DComputeEvent extends Event<Schlegel4DComputeHandler>{
  
  public final static Class<Schlegel4DComputeHandler> TYPE = Schlegel4DComputeHandler.class;
  private final Symmetry4DChooseEvent symmetryEvent;
  private final Point4D pickedPoint;
  
  public Schlegel4DComputeEvent(Symmetry4DChooseEvent symmetry3dChooseEvent, Point4D pickedPoint){
  ...
  @Override
  protected void dispatch(Schlegel4DComputeHandler handler) {
