...
public class FundamentalResultEvent
  extends Event<FundamentalResultHandler>
{

  public final static Class<FundamentalResultHandler> TYPE =
      FundamentalResultHandler.class;
