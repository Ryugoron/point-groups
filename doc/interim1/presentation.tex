...
\begin{frame}{Aufgabe}
	...
	\item und von 4-dimensionalen Polyedern. 
 \only<2->{
...
\begin{frame}{Details zu Aufgabe 1 und 2}
	\begin{itemize}
	\item Selektierung einer Symmetriegruppe (TODO: Bild vom Würfel)
 \only<2->{
	\item Auswahl eines Punktes auf der Oberfläche
	\item Berechnung der Abbildungen des Punktes unter der Symmetriegruppe (TODO: Bild)
}
 \only<3->{
	\item Bilden der konvexen Hülle der resultierenden Punktmenge
