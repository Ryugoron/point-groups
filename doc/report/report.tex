...
pdfauthor={Marcel Ehrhardt, Nadja Scharf, Alexander Steen, Simon Tippenhauer, Oliver Wiese, Maximilian Wisniewski}
%pdfkeywords={}
]{hyperref}
\usepackage{breakurl}
...
\newcommand\fulogo{%
   \put(0,0){%
      \parbox[b][\paperheight]{\paperwidth}{%
         \vspace{1.5cm}
         \begin{center}
	         \includegraphics[width=0.7\textwidth]{img/fulogo.eps}%
         \end{center}
         \vfill{}
      }
   }
...
\author{Marcel Ehrhardt \and Nadja Scharf \and Alexander Steen \and Simon Tippenhauer \and Oliver Wiese \and Maximilian Wisniewski}
\date{
\vspace{1.0cm}
\today{}
}
