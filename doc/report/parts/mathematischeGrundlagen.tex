...
%%%%%%%%%%%%%%%%%  4D-case
\newpage
\subsection{Spiegelungen und Rotationen im vierdimensionalen Raum}
\begin{itemize}
...
\end{itemize} 
Rotationen im vier dimensionalen Raum können als zwei Rotationen im drei dimensionalen Raum dargestellt werden. 
