...
erlaubt einem jedoch eine sehr elegante und schlanke Darstellung von Rotationen: 
...
\noindent Für Spiegelungen können Quaternionen ebenso elegant benutzt werden: Soll ein Punkt  $(p_x, p_y, p_z) \in \mathbb{R}^3$
