...
\begin{definition}[Fundamentalbereich]\label{fundamentalbereich:def} \mbox{}\\
   ...
   Dann ist ein \emph{Fundamentalbereich} $G \setminus S^{n-1}$ -- ein Repräsentantensystem für die Wirkung auf die $(n-1)$--Sphäre.
\end{definition}
\todo{Die Definition des Fundamentalbereichs wirkt irgendwie unglücklich formuliert} 
